/**
 * Created by chenjl on 2018/1/30.
 */
;(function ($) {
    $.fn.spinner = function (opts) {
        return this.each(function () {
            ...
            var textField = $(this).addClass('value').attr({'maxlength':'5','min':'0','oninput':'this.value=this.value.replace(/^[0]+[0-9]*$/gi,"")'}).val(options.value)
            ...
            $(".decrease").attr("onclick",'jian(this)');
            $(".increase").attr("onclick",'jia(this)');
        })
    }
