...
app = Flask(__name__)
app.config["SQLALCHEMY_DATABASE_URI"] = "mysql+pymysql://root:122461@127.0.0.1:3306/movie"
...
class User(db.Model):
    ...
    moviecols = db.relationship('Moviecol', backref='user')  # 电影收藏外键关联关系
...
class Movie(db.Model):
    ...
    moviecols = db.relationship('Moviecol', backref='movie')  # 电影收藏外键关联关系
...
class Comment(db.Model):
    ...
    movie_id = db.Column(db.Integer, db.ForeignKey('movie.id'))  # 电影ID外键关联
